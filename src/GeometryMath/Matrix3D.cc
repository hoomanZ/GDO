...
namespace FiniteElement {
  ...
  {
    out << "[" << matrix.mat3[0][0] << " " << matrix.mat3[0][1] << " " << matrix.mat3[0][2] << std::endl
               << matrix.mat3[1][0] << " " << matrix.mat3[1][1] << " " << matrix.mat3[1][2] << std::endl
               << matrix.mat3[2][0] << " " << matrix.mat3[2][1] << " " << matrix.mat3[2][2] << "]" << std::endl;
    return out;
  }
